...
(function(Scratch) {
  ...
  var ext = {
    ...
    lastSender: function() { return this._lastMsg ? (this._lastMsg.sender_name || "") : ""; },
    lastContent: function() { return this._lastMsg ? extractUrl(this._lastMsg.content) : ""; },
    lastTime: function() { return this._lastMsg ? (this._lastMsg.created_at || "") : ""; },
